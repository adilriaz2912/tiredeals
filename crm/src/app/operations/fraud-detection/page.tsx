        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="card p-6 shadow-lg shadow-rose-500/10">
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-neutral-400 mt-1">Blocked Today</p>
            </div>
          </div>
          ...
          <div className="card p-6">
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-neutral-400 mt-1">Amount Protected</p>
            </div>
          </div>
          ...
          <div className="card p-6">
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-neutral-400 mt-1">Fraud Rate</p>
              <p className="text-xs text-green-400">vs {stats.industryAvg}% industry</p>
            </div>
          </div>
        </div>
          ...
          <div className="lg:col-span-2 card">
            ...
            <div className="divide-y divide-neutral-800/30">
              {filteredTransactions.map((txn) => (
                <div key={txn.id} className="p-6 hover:bg-neutral-800/20 transition-colors">
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <span className="font-mono text-sm text-neutral-400">{txn.id}</span>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                        <div className="flex items-center gap-2">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-neutral-500">{txn.email}</p>
                          </div>
                        </div>
                        <div className="flex items-center gap-2">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <p className="text-sm text-neutral-300">{txn.paymentMethod}</p>
                        </div>
                        <div className="flex items-center gap-2">
                          <MapPin className="w-4 h-4 text-neutral-500" />
                          <p className="text-sm text-neutral-300">{txn.location}</p>
                        </div>
                      </div>
                    ...
                    {txn.status === 'review' && (
                      <div className="flex flex-col gap-2">
                        ...
                        <button className="flex items-center gap-2 px-4 py-2 bg-neutral-700 text-neutral-300 rounded-lg hover:bg-neutral-600 transition-colors">
            ...
            <div className="card">
              ...
              <div className="p-4 space-y-3">
                {fraudPatterns.map((pattern) => (
                  <div key={pattern.pattern} className="p-3 bg-neutral-800/40 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="flex items-center gap-1 text-sm">
                        ...
                        {pattern.trend === 'down' && <TrendingUp className="w-3 h-3 text-green-400 rotate-180" />}
                        <span className={pattern.trend === 'up' ? 'text-rose-400' : pattern.trend === 'down' ? 'text-green-400' : 'text-neutral-400'}>
                          {pattern.count}
                        </span>
                      </span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-neutral-500">Blocked: {pattern.blocked}/{pattern.count}</span>
                      <span className="text-green-400">{Math.round(pattern.blocked / pattern.count * 100)}%</span>
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="card">
              ...
              <div className="p-4 space-y-3">
                {returnFraudSuspects.map((suspect) => (
                  <div key={suspect.customer} className="p-3 bg-neutral-800/40 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
            ...
            <div className="card p-6">
              ...
              <div className="space-y-3">
                <div className="flex justify-between">
                  ...
                  <span className="text-green-400">{stats.falsePositiveRate}%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-400">Detection Accuracy</span>
                  <span className="text-green-400">97.7%</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-400">Avg Review Time</span>
                  <span className="text-white">4.2 min</span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-400">Rules Active</span>
...
function StatusBadge({ status }: { status: string }) {
  const styles: Record<string, { bg: string; icon: React.ReactNode }> = {
    ...
    approved: { bg: 'bg-green-500/20 text-green-400', icon: <CheckCircle className="w-3 h-3" /> },
